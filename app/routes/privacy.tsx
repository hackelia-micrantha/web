const Privacy = () => (
  <div>
    ...
    <p className="mt-8">
      Micrantha Software Solutions operates the <i>micrantha.com</i> websites,
    ...
    <p className="mt-8 font-bold">Log Data</p>
    <p>
    ...
    <p className="mt-8 font-bold">Cookies</p>
    <p>
    ...
    <p className="mt-8 font-bold">Service Providers</p>
    <p>
    ...
    <p className="mt-8 font-bold">Security</p>
    <p>
    ...
    <p className="mt-8 font-bold">Links to Other Sites</p>
    <p>
    ...
    <p className="mt-8 font-bold">Changes to This Privacy Policy</p>
    <p>
    ...
    <p className="mt-8 font-bold">Contact Us</p>
    <p>
