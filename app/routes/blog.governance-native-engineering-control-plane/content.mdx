...
<MermaidDiagram
  ...
  chart="flowchart TD; A[Human intent] --> B[Policy and review boundaries]; B --> C[Agent or model execution]; C --> D[Generated change]; D --> E[Evidence and replay envelope]; E --> F[Human comprehension loop]; F --> B"
/>
