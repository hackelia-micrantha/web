...
sudo service unicorn_micrantha <start|stop|restart>
sudo service sidekiq_micrantha <start|stop>
```
...
```
/home/deployer/apps/micrantha/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_micrantha restart
sudo service sidekiq_micrantha stop
sudo service sidekiq_micrantha start
```
